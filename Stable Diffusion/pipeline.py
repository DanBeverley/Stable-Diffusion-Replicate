...
def generate(prompt , uncond_prompt = None , input_image = None , strength = 0.8 ,
    ...
    with torch.no_grad():
        ...
        # Initialize random number generator according to the seed 
        ...
        for i , timestops in enumerate(timesteps):
            # (1,320)
            ...
            if do_cfg:
                ...
                model_output = cfg_scale * (output_cond - output_cond) + output_uncond
            # (Batch_size , 4 , Latents_Height , Latents_Width) -> (Batch_Size , 4 , Latents_Height , Latents_Width)
